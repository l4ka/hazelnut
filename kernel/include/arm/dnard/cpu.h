 ...
 *                
 * File path:     arm/dnard/cpu.h
 * Description:   DNARD specific functions and declarations.
 *                
 * @LICENSE@
 *                
 ...
 *                
 ********************************************************************/
#ifndef __ARM__DNARD__CPU_H__
#define __ARM__DNARD__CPU_H__
