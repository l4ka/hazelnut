 ...
 *                
 * File path:     arm/ipaq/uart.h
 * Description:   Definitions for the IPaq UART.
 *                
 * @LICENSE@
 *                
 * $Id: uart.h,v 1.1 2002/01/24 07:15:41 uhlig Exp $
 *                
 ********************************************************************/
#ifndef L4__ARM__IPAQ__UART_H
#define L4__ARM__IPAQ__UART_H

/*
 * Base address of UART
 */
#define L4_UART_PBASE	0x80050000
#define L4_UART_BASE	UART_VBASE	/* In platform.h */
