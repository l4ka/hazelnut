/* $Id: sgialib.h,v 1.1 2000/09/14 15:36:34 uhlig Exp $
...
extern pcomponent *prom_getsibling(pcomponent *prom_this);

/* Get child component of THIS. */
extern pcomponent *prom_getchild(pcomponent *prom_this);
 ...
 * failure status.
 */
extern long prom_getcdata(void *buffer, pcomponent *prom_this);

/* Other misc. component routines. */
extern pcomponent *prom_childadd(pcomponent *prom_this, pcomponent *tmp, void *data);
extern long prom_delcomponent(pcomponent *prom_this);
