/* $Id: sgiarcs.h,v 1.2 2001/07/13 20:01:08 ud3 Exp $
 *
...
struct linux_component {
	enum linux_devclass     dclass; /* node class */
...
struct linux_romvec {
	...
	pcomponent *(*next_component)(pcomponent *prom_this);
	pcomponent *(*child_component)(pcomponent *prom_this);
	...
	pcomponent *(*child_add)(pcomponent *prom_this,
				 pcomponent *tmp,
				 void *opaque_data);
	long (*comp_del)(pcomponent *prom_this);
