/*
 *	$Id: libpci.h,v 1.1 2000/02/21 19:16:58 uhlig Exp $
 *
...
#define _WASNOTDEFINED___KERNEL__
#define __KERNEL__
...
#if !defined(__L4__)
#define _WASNOTDEFINED___L4__
#define __L4__
#endif

#if !defined(CONFIG_PCI)
#define _WASNOTDEFINED_CONFIG_PCI
#define CONFIG_PCI
#endif

#if !defined(CONFIG_PCI_GOANY)
#define _WASNOTDEFINED_CONFIG_PCI_GOANY
#define CONFIG_PCI_GOANY
#endif

#if !defined(CONFIG_PCI_BIOS)
#define _WASNOTDEFINED_CONFIG_PCI_BIOS
...
#define  PCI_CB_BRIDGE_CTL_PARITY	0x01	/* Similar to standard bridge control 
register */
...
#define  PCI_CB_BRIDGE_CTL_PREFETCH_MEM0 0x100	/* Prefetch enable for both memory 
regions */
#define  PCI_CB_BRIDGE_CTL_PREFETCH_MEM1 0x200
#define  PCI_CB_BRIDGE_CTL_POST_WRITES	0x400
#define PCI_CB_SUBSYSTEM_VENDOR_ID 0x40
#define PCI_CB_SUBSYSTEM_ID	0x42
#define PCI_CB_LEGACY_MODE_BASE	0x44	/* 16-bit PC Card legacy mode base address 
(ExCa) */
/* 0x48-0x7f reserved */
...
int pcibios_find_class (unsigned int class_code, unsigned short index, unsigned char *bus, 
...
extern inline struct pci_dev *pci_find_device(unsigned int vendor, unsigned int device, struct 
pci_dev *from)
{ return NULL; }
...
#if defined(_WASNOTDEFINED___KERNEL__)
#undef __KERNEL__
#undef u8
#undef u16
#undef u32
#endif
#undef _WASNOTDEFINED___KERNEL__

#if defined(_WASNOTDEFINED___L4__)
#undef __L4__
#endif
#undef _WASNOTDEFINED___L4__

#if defined(_WASNOTDEFINED_CONFIG_PCI)
#undef CONFIG_PCI
#endif
#undef _WASNOTDEFINED_CONFIG_PCI

#if defined(_WASNOTDEFINED_CONFIG_PCI_GOANY)
#undef CONFIG_PCI_GOANY
#endif
#undef _WASNOTDEFINED_CONFIG_PCI_GOANY

#if defined(_WASNOTDEFINED_CONFIG_PCI_BIOS)
#undef CONFIG_PCI_BIOS
#endif
#undef _WASNOTDEFINED_CONFIG_PCI_BIOS
