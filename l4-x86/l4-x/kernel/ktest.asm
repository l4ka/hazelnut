include l4pre.inc 
  ...
  Copyright IBM+UKA, L4.KTEST, 24,03,00, 15
...
;  OD
  ...
  DO  
    ...
    ;    
        ...
        if    random_sampling   
              bts   dword ptr gs:[7*4],0
              bts   dword ptr gs:[7*4],2   
              IFNC
                    mov   dword ptr gs:[0],0
              FI
        endif
...
;
;        mov   [ping_snd_msg+msg_dope],(2 SHL md_mwords) + (1 SHL md_strings)
;        mov   [ping_snd_msg+msg_size_dope],(2 SHL md_mwords) + (1 SHL md_strings)
;        mov   [ping_snd_msg+msg_w3].str_len,KB4
;        mov   [ping_snd_msg+msg_w3].str_addr,MB1
;        mov   [ping_rcv_msg+msg_dope],(2 SHL md_mwords) + (1 SHL md_strings)
;        mov   [ping_rcv_msg+msg_size_dope],(2 SHL md_mwords) + (1 SHL md_strings)
;        mov   [ping_rcv_msg+msg_w3].buf_size,KB4
;        mov   [ping_rcv_msg+msg_w3].buf_addr,MB1
;
;        mov   [pong_snd_msg+msg_dope],(2 SHL md_mwords) + (1 SHL md_strings)
;        mov   [pong_snd_msg+msg_size_dope],(2 SHL md_mwords) + (1 SHL md_strings)
;        mov   [pong_snd_msg+msg_w3].str_len,KB4
;        mov   [pong_snd_msg+msg_w3].str_addr,MB1+KB4
;        mov   [pong_rcv_msg+msg_dope],(2 SHL md_mwords) + (1 SHL md_strings)
;        mov   [pong_rcv_msg+msg_size_dope],(2 SHL md_mwords) + (1 SHL md_strings)
;        mov   [pong_rcv_msg+msg_w3].buf_size,KB4
;        mov   [pong_rcv_msg+msg_w3].buf_addr,MB1+KB4
;
;        mov   eax,MB2
...
;
        ...
        if    random_sampling
              ...
              mov   ebx,dword ptr gs:[4]
              mov   ecx,dword ptr gs:[8]
              mov   edx,dword ptr gs:[12]
              mov   esi,dword ptr gs:[16]
              mov   edi,dword ptr gs:[20]
              mov   ebp,dword ptr gs:[24]
        endif
...
;        extern kpage_get_clock_usc:near
;        DO
;              call  kpage_get_clock_usc
;              ke    'get_clock'
;              REPEAT
;        OD
