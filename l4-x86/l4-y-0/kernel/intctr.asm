include l4pre.inc 
  ...
  Copyright IBM, L4.INTCTR, 24,02,00, 9057
...
initial_idt    dd offset divide_error_handler+KR
               db dpl3
               dd offset initial_debug_exception_handler+KR
               db dpl0
               dd 0
               db dpl0
               dd offset breakpoint_handler+KR
               db dpl3
               dd offset overflow_handler+KR
               db dpl3
               dd offset bound_check_handler+KR
               db dpl3
               dd offset invalid_opcode_handler+KR
               db dpl0
               dd 0
               db dpl0
               dd offset double_fault_handler+KR
               db dpl0
               dd 0
               db dpl0
               dd 0
               db dpl0
               dd offset seg_not_present_handler+KR
               db dpl0
               dd offset stack_exception_handler+KR
               db dpl0
               dd 0
               db dpl0
               dd 0
               ...
               dd 0
               db dpl0
               dd offset co_error_handler+KR
               db dpl0
               dd offset alignment_check_handler+KR
               db dpl0
               dd offset machine_check_exception+KR
               db dpl0
...
exception:
  ...
  IFZ   al,general_protection,long   ; recall: linear_space is only valid
      
        movzx ebx,word ptr ss:[esp+ip_error_code]
        
        IFB_  ebx,sizeof gdt,long 
                                               ;         data segment
              ...
              IFNZ  edx,ecx                    ;
                    ...
                    FI                         ;     if within kernel !
                    mov   es,ecx               ;     (DS might be kernel seg)
                    ipost                      ;
              FI                               ;
 


              IFZ   ebx,linear_space AND -4       ;;;;;; linear_space !! not _exec
              CANDA [esp+ip_eip],PM               ;;;;;; provisional, only for SYSEXIT
                  ...
                  exc_sysexit:
                    ...
                    mov   ss:[ebp+iret_cs],linear_space_exec
                    lss   esp,fword ptr ss:[esp+iret_esp]
...
perhaps_kd_exception:
  ...
  movzx ebx,ss:[logical_info_page].kdebug_max_task
  test  ebx,ebx
  IFNZ
        lno___task ecx,esp
        cmp   ecx,ebx
