/* 
 * $Id: ipc.h,v 1.1 2001/03/07 11:30:48 voelp Exp $
 */
...
L4_INLINE int
l4_i386_ipc_call3 (l4_threadid_t dest, 
		 const void *snd_msg, dword_t snd_dword0, dword_t snd_dword1, dword_t snd_word2,
		 void *rcv_msg, dword_t *rcv_dword0, dword_t *rcv_dword1, dword_t *rcv_dword2,
		 l4_timeout_t timeout, l4_msgdope_t *result)
{
  struct {
    dword_t d1, d2, d3;
  } dwords = {snd_dword0, snd_dword1, snd_dword2};
...
L4_INLINE int
l4_i386_ipc_reply_and_wait3 (l4_threadid_t dest, 
			   const void *snd_msg, 
