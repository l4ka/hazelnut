...
init_pagmap:
  ...
  mov   bl,fpage_unmap
  mov   eax,offset unmap_fpage_sc+KR
...
unmap_fpage_sc:
  ...
  IFNC
        ...
        push  offset unmap_fpage_ret+KR
        ...
        IFNS
              ...
              IFNZ
                    push  offset unmap_page+KR
                    jmp   short do_fpage
              FI
              push  offset unmap_write_page+KR
              jmp   short do_fpage
        FI
        ...
        IFNC
              test  ch,page_write_permit
              IFNZ
                    push  offset flush_page+KR
                    jmp   short do_fpage
              FI
              push  offset flush_write_page+KR
              jmp   short do_fpage
        FI

              test  ch,page_cache_disable
              IFZ
                    push  offset set_page_cacheable+KR
              ELSE_
                    push  offset set_page_uncacheable+KR
              FI
              jmp   short do_fpage
...
XHEAD lock_shadow_ptab
  ...
  CANDZ [ebx*4+ptab_backlink],0
        ...
        IFZ   [ebp+operation],<offset grant_page_+KR>
              push  ecx
...
flush_address_space:
  ...
  push  edi
  push  offset flush_address_space_ret+KR
