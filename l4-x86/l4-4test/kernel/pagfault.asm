include l4pre.inc 
  ...
  Copyright GMD, L4.PAGFAULT, 04,07,96, 160, K
...
init_pagfault:
  ...
  mov   eax,offset page_fault_handler+PM
  mov   bl,page_fault
  mov   bh,0
...
page_fault_handler:
  ...
  cmp   ss:[esp+iret_cs+4],linear_kernel_space_exec
  ...
  IFB_  edx,<virtual_space_size>,long  
        ...
        IFNZ  [ebp+thread_state],locked

              sub   eax,eax
              mov   ecx,32*4+map_msg

              push  0
              push  linear_kernel_space_exec
              push  offset ipcret+PM
              jmp   ipc_sc
              ipcret:
