include l4pre.inc 
  ...
  Copyright GMD, L4.INTCTR, 02,01,97, 200
...
initial_idt    dd offset divide_error_handler+PM
               db dpl3
               dd offset initial_debug_exception_handler+PM
               db dpl0
               dd 0
               db dpl0
               dd offset breakpoint_handler+PM
               db dpl3
               dd offset overflow_handler+PM
               db dpl3
               dd offset bound_check_handler+PM
               db dpl3
               dd offset invalid_opcode_handler+PM
               db dpl0
               dd 0
               db dpl0
               dd offset double_fault_handler+PM
               db dpl0
               dd 0
               db dpl0
               dd 0
               db dpl0
               dd offset seg_not_present_handler+PM
               db dpl0
               dd offset stack_exception_handler+PM
               db dpl0
               dd 0
               db dpl0
               dd 0
               ...
               dd 0
               db dpl0
               dd offset co_error_handler+PM
               db dpl0
               dd offset alignment_check_handler+PM
               db dpl0
               dd offset machine_check_exception+PM
               db dpl0
...
define_idt_gate:
  ...
  rol   ebx,16
  rol   eax,16
  mov   ax,linear_kernel_space_exec
  rol   eax,16
  mov   bl,0
  add   bh,80h+intrgate
...
exception:
  ...
  lea   ebp,[eax*8+ebp]               ; idt_base is always valid
