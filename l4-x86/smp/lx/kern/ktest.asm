...
rsend_task_no equ 7
rsend_task    equ (rsend_task_no SHL task_no+initial_version+root_chief_no SHL chief_no)

rmaster:  
              mov eax,0ffh                ; mcp
              mov ebx,sigma0_task         ; pager
              mov ecx,rstack1             ; initial sp
              mov edx,rsend               ; initial ip
              mov esi,rsend_task          ; task no
              int task_new
              jmp $

rsend:        ke 'task running'
