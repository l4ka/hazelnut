...
create_thread:
  ...
  CANDA ebp,max_kernel_tcb
        ...
        mov   esi,[eax+as_size]
        mov   [ebp+as_size],esi
        mov   esi,[eax+thread_seg]
        mov   [ebp+thread_seg],esi
  ...
  mov   eax,[ebp+thread_seg]
  mov   dword ptr [ebx+ip_ds+4],eax
  mov   dword ptr [ebx+ip_es+4],eax
  add   eax,8
  mov   dword ptr [ebx+ip_cs+4],eax
